...
public class HordeFollowManager : MonoBehaviour
{
    ...
    [SerializeField] public List<GameObject> fleetBody = new List<GameObject>();
    ...
    void CreatefleetParts()
    {
        ...
        {
            GameObject temp = Instantiate(fleetParts[0], markM.markerList[0].position, markM.markerList[0].rotation, transform.parent);
